...
og_img: how-a-devtools-extension-is-made-og.png
---
...
After all the initial boilerplate, here is where stuff gets interesting 🎉. This DevTools extension follows a model based on two main actors: _backend_ and _frontend_.

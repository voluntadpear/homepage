            ...
            <div class="md:flex lg:justify-between lg:pt-16 lg:max-w-4xl">
              ...
              <div>
                ...
                <p class="pt-4 md:max-w-md">
                  ...
                  <span class="font-semibold">Stripe</span>, where I'm part of
                  the platform team that enables product teams to perform
                  routing, data fetching, testing and add observability to their
                  workflows.
                </p>
                <p class="pt-4 md:max-w-md">
          ...
          <div class="lg:max-w-5xl lg:mx-auto space-y-6 md:space-y-12">
            ...
            <div class="flex flex-col md:flex-row">
              <p class="md:max-w-md">
                ...
                <span class="font-semibold">guillescura[at]gmail.com</span> or
